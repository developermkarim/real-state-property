...
<div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                @php
                    $property_ameni_ids = explode(',', $property->amenities_id);
                @endphp
                 <tr> 
 ...
 <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                ...
                <option  disabled value="{{ $ameni->amenitis_name }}" {{ (in_array($ameni->id,$property_ameni_ids)) ? 'selected' : '' }} >{{ $ameni->amenitis_name }}</option>
               @endforeach
